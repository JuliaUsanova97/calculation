describe("Successfully results for one investor", () => {
    ...
    it("Successfully submit rent-control", () => {
        ...
        cy.get('.dLFTSb').contains('1 603&nbsp;€');
        cy.get('[class="styles__ResultsContainer-sc-cwpsyg-2 hiygNZ"]').children().eq(0).should('have.text','29,2 €');
        cy.get('[class="styles__ResultsContainer-sc-cwpsyg-2 hiygNZ"]').children().eq(1).should('have.text','24,3 €');
